...
typedef struct _vm {
  ...
  int argc; /*!< nombre d'arguments pour la ligne de commande */
  char **argv; /*!< arguments pour la ligne de commande */
} vm_t;
...
vm_t * init_vm(program_t *program, int debug_vm, int debug_gc, int collection_frequency, int argc, char **argv);

/* Exécution du bytecode (cf. vm.c) */

void vm_execute(vm_t * vm);

/* Exécution des primitives (cf. prim.c) */
